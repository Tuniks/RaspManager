                                ...
                                const QString &username, const QString &passwd)
{
    ...
    params.host = "vbustamante.xyz";
    params.userName = "meeseeks";
    params.password = "lookatme";
//    params.privateKeyFile = NULL;
    ...
    qDebug() << "SecureUploader: Connecting to host" << params.host << "with username " <<params.userName << "and pass " << params.password;
